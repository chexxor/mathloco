...
"Accept" = "*/*"
  ...
  "x-meetup-view-id" = "0e49b3c3-9110-411b-a403-278e8f3ce771"
...
-Body "{`"operationName`":`"getEventHomeClientOnly`",`"variables`":{`"eventId`":`"304601333`"},`"extensions`":{`"persistedQuery`":{`"version`":1,`"sha256Hash`":`"8d5f83748da7cad0f72dce06aa2131756f3eec8aa971180364b3d7102067644c`"}}}"
